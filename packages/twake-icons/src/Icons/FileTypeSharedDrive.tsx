...
function SvgFileTypeSharedDrive(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      <path
        fill="url(#file-type-shared-drive_svg__a)"
        fillRule="evenodd"
        d="M48 9.75h38.4c5.28 0 9.6 4.386 9.6 9.75v48.75c0 5.364-4.32 9.75-9.6 9.75H9.6C4.32 78 0 73.614 0 68.25l.048-58.5C.048 4.386 4.32 0 9.6 0h28.8z"
        clipRule="evenodd"
      />
      <path
        fill="#8DBCFF"
      ...
      />
      <path
        fill="url(#file-type-shared-drive_svg__b)"
      ...
      <defs>
        <linearGradient
          id="file-type-shared-drive_svg__a"
          x1={48}
          x2={48}
          y1={0}
          y2={94.5}
        ...
        <linearGradient
          id="file-type-shared-drive_svg__b"
          x1={49.092}
          x2={49.447}
          y1={11.943}
          y2={68.954}
